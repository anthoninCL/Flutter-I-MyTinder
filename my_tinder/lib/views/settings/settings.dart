...
class _SettingsState extends State<Settings> {
  ...
  void saveSettings() async {
    ...
    widget.profile.value!.ageRange =
        ageRange.start.toString() + "-" + ageRange.end.toString();
    widget.profile.value!.range = range.toInt();
    widget.profile.value!.email = email;
    widget.profile.value!.phoneNumber = phoneNumber;
    s.setString(
