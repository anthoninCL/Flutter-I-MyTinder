...
class Constants {
  static List<Match> matches = [
    Match(
      ...
      [
        Lifestyle("Zodiac Sign", "Aries", false, MdiIcons.weatherNight),
        ...
        Lifestyle("Sport", "Regular at the gym", false, MdiIcons.basketball),
        Lifestyle(
          "Cigarettes",
          "Unspecified",
          false,
  ...
  static List<Conversation> messages = [
    Conversation("Marine", "assets/images/profile_pic_9.jpg", [
      Message("Hey!", "14:32", false),
      Message("Hello nice to meet you, what's going on in your life?", "14:40",
          true)
    ]),
    Conversation("Sam", "assets/images/profile_pic_6.jpg", [
      Message("Hello James, what's up?", "10:17", false),
    ]),
    Conversation("Julie", "assets/images/profile_pic_10.jpg", [
    ...
    Conversation("Lucina", "assets/images/profile_pic_1.jpg", [
      Message("Nice to meet you James!", "11:47", false),
    ]),
    Conversation("Sandy", "assets/images/profile_pic_5.jpg", [
      Message("Hello!", "21:12", false),
      Message("Hey Sandy!", "21:23", true),
      Message("How are you?", "21:24", true),
    ]),
    Conversation("Jin", "assets/images/profile_pic_7.jpg", [
      Message("What's up?", "23:10", false),
    ]),
    Conversation("Marta", "assets/images/profile_pic_8.jpg", [
      Message("Hello hello James!", "12:50", false),
    ]),
    Conversation("Jandice", "assets/images/profile_pic_2.jpg", [
